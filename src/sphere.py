...
class Sphere(Model):
    def __init__(self, position=(0,0,0), rotation=(0,0,0), scale=(1,1,1), name="sphere", hittable=True, sectors=24, stacks=16):
        self.name = name
        ...
        for i in range(stacks + 1):
            ...
            for j in range(sectors + 1):
                ...
                # Position
                vertices_list.extend([x, y, z])
                # Color
                r = (x + 1) / 2
                g = (y + 1) / 2
                b = (z + 1) / 2
                colors_list.extend([r, g, b])
        # Indices
        ...
        colors = np.array(colors_list, dtype='f4')
